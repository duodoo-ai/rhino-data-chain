...
class account_journal(models.Model):
    ...
    def get_line_graph_datas(self):
        ...
        query = '''
            ...
            FROM cncw_invoice_move move ON move.id = st_line.move_id
    ...
    def get_journal_dashboard_datas(self):
        ...
        if self.type in ('bank', 'cash'):
            ...
            self._cr.execute('''
                ...
                FROM account_bank_statement_line st_line
                JOIN cncw_invoice_move st_line_move ON st_line_move.id = st_line.move_id
        ...
        #TODO need to check if all invoices are in the same currency than the journal!!!!
            ...
            title = _('Bills to pay') if self.type == 'purchase' else _('Invoices owed to yo')
    ...
    def open_action_with_context(self):
        ...
        if not action_name:
            ...
            action_ref = 'account.'.join(action_name)
